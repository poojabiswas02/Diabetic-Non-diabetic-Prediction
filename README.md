...
The objective is to predict whether or not a patient has diabetes. The Dataset used in this project is originally from NIDDK. Visually explored variables using histograms. Created scatter charts between the variables to understand the relationships. Performed correlation analysis and visually explored it using heat map. Devised strategies for model building. Built a KNN algorithm and compared various models with the results. Created a classification report by analyzing sensitivity, specificity, AUC(ROC curve), etc. Created a dashboard in tableau by choosing appropriate chart types and metrics useful for the business.
Context:
...
https://public.tableau.com/app/profile/pooja1602/viz/Health_care_project/DiabetesAnalysisDashboard




![Screenshot (101)](https://user-images.githubusercontent.com/104248010/164970745-18296df9-d8db-4cb7-a8f4-aa977498d096.png)
